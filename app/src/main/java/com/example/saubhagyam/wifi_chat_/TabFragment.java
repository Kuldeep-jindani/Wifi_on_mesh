...
public class TabFragment extends Fragment {
    ...
    public static void setWiFiChatFragmentList(List<WiFiChatFragment> wiFiChatFragmentList) {
        TabFragment.wiFiChatFragmentList = wiFiChatFragmentList;
    }
    ...
    public static void setWiFiP2pServicesFragment(WiFiP2pServicesFragment wiFiP2pServicesFragment) {
        TabFragment.wiFiP2pServicesFragment = wiFiP2pServicesFragment;
    }
