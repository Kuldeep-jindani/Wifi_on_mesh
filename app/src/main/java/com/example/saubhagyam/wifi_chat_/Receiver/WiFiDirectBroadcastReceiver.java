...
import com.example.saubhagyam.wifi_chat_.DeviceDetailFragment;
import com.example.saubhagyam.wifi_chat_.DeviceListFragment;
...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            Log.d("Main Activity", "P2P state changed - " + state);
            ...
            Log.d("Main Activity", "P2P peers changed");
